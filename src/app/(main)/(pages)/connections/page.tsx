...
const Connections = async (props: Props) => {
  ...
  return (
    <div className='relative flex flex-col gap-4'>
        <h1 className='sticky top-0 z-[10] flex item-center justify-between border-b bg-background/50 p-6 text-4xl backdrop-blur-lg'>
            Connections
        </h1>
        <div className='relative flex flex-col gap-4'>
            <section className='flex flex-col relative  p-6 text-muted-foreground gap-4'>
